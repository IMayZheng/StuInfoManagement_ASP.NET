<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GradeStudent.aspx.cs" Inherits="web.GradeStudent" %>
...
&nbsp;<asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="查  询" />
            ...
            <tr>
                <td colspan="3">
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" PageSize="5" Width="881px" DataKeyNames="ID" OnPageIndexChanging="GridView1_PageIndexChanging1" OnRowCreated="GridView1_RowCreated" OnRowDeleting="GridView1_RowDeleting" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
